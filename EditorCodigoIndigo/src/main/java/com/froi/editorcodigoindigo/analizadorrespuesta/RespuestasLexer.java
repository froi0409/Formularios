    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 34: break;
          case 12:
            { System.out.println("ALLCHARACTERS: "); return new Symbol(ALLCHARACTERS, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 35: break;
          case 13:
            { System.out.println("TIPO: "); return new Symbol(TIPO, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 36: break;
          case 14:
            { System.out.println("DETALLES: "); return new Symbol(DETALLES, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 37: break;
          case 15:
            { System.out.println("DESCRIPCION: "); return new Symbol(DESCRIPCION, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 38: break;
          case 16:
            { System.out.println("FIN_RESPUESTA: "); return new Symbol(FIN_RESPUESTA, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 39: break;
          case 17:
            { System.out.println("INI_RESPUESTA: "); return new Symbol(INI_RESPUESTA, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 40: break;
          case 18:
            { System.out.println("FIN_RESPUESTAS: "); return new Symbol(FIN_RESPUESTAS, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 41: break;
          case 19:
            { System.out.println("INI_RESPUESTAS: "); return new Symbol(INI_RESPUESTAS, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 42: break;
          case 20:
            { System.out.println("INSTRUCCIONES: "); return new Symbol(INSTRUCCIONES, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 43: break;
          case 21:
            { System.out.println("ERROR_DETECTADO: "); return new Symbol(ERROR_DETECTADO, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 44: break;
          case 22:
            { System.out.println("DESCRIPCION_ERROR: "); return new Symbol(DESCRIPCION_ERROR, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 45: break;
          case 23:
            { System.out.println("INSTRUCCION_EJECUTADA: "); return new Symbol(INSTRUCCION_EJECUTADA, yyline+1, yycolumn+1, yytext());
            }
            // fall through
          case 46: break;
          default:
